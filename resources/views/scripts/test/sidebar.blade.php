<script>
    ...
    SidebarData.prototype.getSidebarData = function (milisecond = 6000) {
        this.md         = Math.floor(Math.random() * 2000);
        this.rpm        = Math.floor(Math.random() * 200);
        this.ropi       = Math.floor(Math.random() * 200);
        this.scfm       = Math.floor(Math.random() * 4000);
        this.woba       = Math.floor(Math.random() * 100);
        this.hklda      = Math.floor(Math.random() * 200);
        this.torqa      = Math.floor(Math.random() * 50);
        this.stppress   = Math.floor(Math.random() * 5000);
        this.deptbitv   = Math.floor(Math.random() * 2000);
        this.blockpos   = Math.floor(Math.random() * 100); 
        this.bitdepth   = Math.floor(Math.random() * 2000);
        this.mudflowin  = Math.floor(Math.random() * 3000);
        this.mudflowout = Math.floor(Math.random() * 3000);
    ...
    SidebarData.prototype.initSidebar = async function () {
        ...
        setInterval(async () => { this.getSidebarData() }, 1000);
    }
